...
namespace CustomPlayerController
{
    public class CustomAnimationController: MonoBehaviour
    {
        ...
        void Update () 
        {
        	...
        	//Split up velocity;
        	Vector3 _horizontalVelocity = CustomVectorMath.RemoveDotVector(_velocity, tr.up);
        	...
        	animator.SetFloat("VerticalSpeed", _verticalVelocity.magnitude * CustomVectorMath.GetDotProduct(_verticalVelocity.normalized, tr.up));
