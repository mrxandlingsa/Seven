...
{
    public class CustomTurnTowardControllerVelocity: MonoBehaviour
    {
        //Target controller;
		...
		void LateUpdate () {
			...
			float _angleDifference = CustomVectorMath.GetAngle(_currentForward, _velocity, parentTransform.up);
